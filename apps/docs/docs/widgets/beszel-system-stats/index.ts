  ...
  configuration: {
    items: [
      ...
      },
      {
        ...
        description:
          "Select a GPU-related temperature sensor reported by Beszel, or keep automatic matching. Available sensors load from the selected system and exclude CPU, storage, network, and other unrelated sensors.",
